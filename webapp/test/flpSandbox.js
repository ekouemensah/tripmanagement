		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tripmanagementtripmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tripmanagementtripmanagement-display": {
								"semanticObject": "tripmanagementtripmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tripmanagement.tripmanagement",
									"url": sap.ui.require.toUrl("tripmanagement/tripmanagement")
								}
							}
						}
					}
